...
public class Aufgabe4{
    ...
    public static int sum2(int n) {
        ...
        return n>0?n+sum1(n-1):0; //diese Anweisung ändern oder löschen.
    }
    ...
    public static int sum3(int n) {
        ...
        return n>=0?n+sumNMinusOne(n-1)+n-1:0; //diese Anweisung ändern oder löschen.
    }
    ...
    public static int sum4(int n) {
        // TODO: Impl. Sie diese Methode durch einen Aufruf von sumNMinusOne.
        return n<0?0:n+sumNMinusOne(n-1)+n-1; //diese Anweisung ändern oder löschen.
    }
    
    // liefert für n >= 0 die Summe der Zahlen von 0 bis n;
    // für negative n soll 0 geliefert werden.
    public static int sum5(int n) {
        return n>=0?n+sum5(n-1):0;// TODO: Implementieren Sie diese Methode.

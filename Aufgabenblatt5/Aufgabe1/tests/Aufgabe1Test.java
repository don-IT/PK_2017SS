...
public class Aufgabe1Test {
    ...
    public void testAufgabe1() throws Exception {
        ...
        Method rem = Aufgabe1.class.getDeclaredMethod("rem", String.class);
        assertEquals(true, rem.getReturnType().equals(String.class));
        ...
        assertEquals("task removed", rem.invoke(plan1, "Sonnenhut tragen"));
        assertEquals("no entry", rem.invoke(plan1, "Abendessen"));
        assertEquals(null, to.invoke(plan1, "Sonnenhut tragen"));
    }
}
